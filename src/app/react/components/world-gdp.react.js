...
import CountryGdp from './world-gdp-card.react';
...
export class WorldGdpReactComponent extends React.Component {
  constructor(props) {
    super(props);
    const countryCode = [];
...
WorldGdpReactComponent.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(WorldGdpReactComponent);
